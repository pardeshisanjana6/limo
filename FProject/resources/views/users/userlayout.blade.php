...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@300;400;500;600;700;800;900&family=Poppins:wght@300;400;500;600;700;800;900&display=swap"
        rel="stylesheet" />
...
<body data-bs-spy="scroll" data-bs-target="#header-nav" tabindex="0">
  <nav class="navbar navbar-expand-lg navbar-light container-fluid py-3 position-fixed">
    <div class="container">
      <a class="navbar-brand" href="{{ route('about') }}"><img src="{{ asset('images/logo.png') }}" alt="logo" /></a>
      ...
      <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
        ...
        <div class="offcanvas-body">
          <ul class="navbar-nav align-items-center justify-content-end flex-grow-1 pe-3">
            <li class="nav-item">
              <a class="nav-link active px-3" aria-current="page" href="{{route('home2')}}">Home</a>
            </li>
            <li class="nav-item">
              <a class="nav-link px-3" href="{{ route('about') }}">About</a> 
            </li>
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="{{ route('cars') }}" id="navbarDropdownCars" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                Cars
              </a>
              <ul class="dropdown-menu" aria-labelledby="navbarDropdownCars">
                <li><a class="dropdown-item" href="{{ route('cars') }}">All</a></li> 
                <li><a class="dropdown-item" href="{{ route('cars', ['seating_capacity' => 2]) }}">2 Seater</a></li>
                <li><a class="dropdown-item" href="{{ route('cars', ['seating_capacity' => 4]) }}">4 Seater</a></li>
                <li><a class="dropdown-item" href="{{ route('cars', ['seating_capacity' => 6]) }}">6 Seater</a></li>
                <li><a class="dropdown-item" href="{{ route('cars', ['seating_capacity' => 7]) }}">7 Seater</a></li>
              </ul>
            </li>
            <li class="nav-item">
              <a class="nav-link px-3" href="{{ route('blog') }}">Blog</a> 
            </li>
            <li class="nav-item">
              <a class="nav-link px-3" href="{{ route('contact.show') }}">Contact</a> 
            </li>
            @auth 
            <li class="nav-item">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <li><a class="dropdown-item" href="{{route('home2')}}">My Profile</a></li>
            ...
            <li class="nav-item">
              <a class="nav-link px-3" href="{{ route('register') }}">Registration</a> 
            </li>
            @endguest
          </ul>
        </div>
